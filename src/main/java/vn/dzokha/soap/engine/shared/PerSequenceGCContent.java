...
import vn.dzokha.soap.engine.gc.GCModel;
import vn.dzokha.soap.engine.gc.GCModelValue;
import vn.dzokha.soap.model.sequence.Sequence;
import vn.dzokha.soap.util.NormalDistribution;
import vn.dzokha.soap.dto.PointDTO; // Đảm bảo đã có DTO này
