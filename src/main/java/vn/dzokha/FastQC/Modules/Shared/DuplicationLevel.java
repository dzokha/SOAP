...
public class DuplicationLevel extends AbstractQCModule {
	...
	private LineGraph graph; // THÊM BIẾN NÀY
...
//		System.err.println("Count at limit = "+countAtLimit+" total = "+totalCount+" Dup level = "+duplicationLevel+" no obs = "+numberOfObservations);
    ...
    //     data[0] = totalPercentages;
    //     data[1] = deduplicatedPercentages;
        
    //     String [] titles = new String [] {"Total sequences", "Deduplicated sequences"};
    //     graph = new LineGraph(data, 0, 100, "Sequence Duplication Level", titles, labels, "Percent of total sequences");
    //     return graph;
    // }
